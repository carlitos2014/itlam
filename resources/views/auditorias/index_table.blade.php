    ...
    @foreach($auditorias as $auditoria)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('auditorias.buildPdf', [$auditoria->id]) !!}" class='btn btn-default btn-xs' target="_blank"><i class="fa fa-fw fa-file-pdf-o text-danger" aria-hidden="true"></i></a>
